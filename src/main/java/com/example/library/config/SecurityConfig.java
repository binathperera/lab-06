...
import com.example.library.security.JwtAuthTokenFilter;
@Configuration
@EnableWebSecurity
...
public class SecurityConfig {
    ...
    // // 🔒 Use explicit origin — "*" will fail if you use credentials or auth
    // headers
    // // configuration.setAllowedOrigins(List.of(clientUrl));
    // configuration.setAllowedOrigins(List.of("http://43.204.141.135",
    // "http://localhost:5173"));
